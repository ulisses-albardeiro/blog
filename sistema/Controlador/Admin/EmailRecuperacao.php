...
class EmailRecuperacao extends Controlador
{
    ...
    public function emailRecuperacao(): void
    {
    ...
    private function enviarEmail(string $email, string $nome): void
    {
        ...
        $enviar->criar('Reculperação de senha Blog', $this->corpoEmail(), $email, $nome);
        $enviar->enviar(USUARIO_EMAIL, 'Reculperação de senha');
    }
}
